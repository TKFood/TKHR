                ...
                if (!string.IsNullOrEmpty(dateTimePicker1.Value.ToString()))
                {
                    ...
                    else
                    {
                        ...
                        if (dialogResult == DialogResult.Yes)
                        {
                            ...
                            //ADD COPTC
                            sbSql.Append(" ");
                            sbSql.AppendFormat(" DELETE   [TKHR].[dbo].[MONTHDEPOVERTIME]  WHERE  [HRYEARS]='{0}' AND [HRMONTHS]='{1}' ", dateTimePicker2.Value.Year.ToString(), dateTimePicker2.Value.Month.ToString());
