    ...
    public partial class frmSAL : Form
    {
        ...
        public void Search()
        {
            try
            {
                ...
                sbSql.Append(@"SELECT [ID] AS '工號',[NAME] AS '姓名',[YEARS] AS '年資',[JOBLEVEL] AS '職等',[JOBYEAR] AS '職級',[TOTALMONEY] AS '總薪資',[SALJOB] AS '主管',[SALJOBLEVEL] AS '薪資點',[SALJOBALOWANCE] AS '幕僚',[SALEMPALOWANCE] AS '職能別',[SALOTHER] AS '久任',[JOBADD] AS '主管津貼',[JOBALOWANCEADD] AS '幕僚加給',[EMPALOWANCEADD] AS '職能加給' FROM [TKHR].[dbo].[SALEMPINFO] ");
